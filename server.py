...
def sql_write_origin_img(frame):
    ...
    cursor.execute(insert into "origin_img"("origin_img_id","img","img_time") VALUES (last_num,frame,time_now);)

def sql_find_last_origin_img(frame):
    pass
